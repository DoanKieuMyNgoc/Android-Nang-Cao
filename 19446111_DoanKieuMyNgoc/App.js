    ...
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', backgroundColor: "#edebe6" }}>
        <View style={{ margin: 5, flex: 1 }}>
          <Image style={{ width: 45, height: 45 }} source={require("./assets/search.jpg")}></Image>
        </View>
        <TextInput
          style={{ flex: 7 }}
          placeholder='Search'
      ...
      <View style={{ flexDirection: 'row', marginVertical: 20 }}>
        <TouchableOpacity>
          <View style={{ marginLeft: 30, backgroundColor: "#141108", borderRadius: 5, padding: 5 }}>
            <Text style={{ color: "#edebe6" }}>ALL BAGS</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={{ marginLeft: 30, backgroundColor: "#edebe6", borderRadius: 5, padding: 5 }}>
            <Text >BACKPACKS</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
